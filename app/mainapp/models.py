...
class Group(models.Model):
    ...
    post_permission = models.CharField(max_length=50, default='all')  # all / members / admin
...
class Comment(models.Model):
    ...
    def __str__(self):
        return f"Comment by {self.user.username} on {self.post.music.name}"# from django.db import models
