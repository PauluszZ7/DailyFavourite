...
from mainapp.models import FriendsCombinations, UserMeta, Group, Music, Post, Comment, Vote
...
class DTOEnum(Enum):
    ...
    def getModel(self):
        ...
        if self.value == "User":
            ...
            return Vote
        elif self.value == "Friend":
            return FriendsCombinations
    ...
    def getSerializer(self):
        ...
        if self.value == "User":
            ...
            return FriendsCombinationsSerializer
